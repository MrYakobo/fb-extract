...
function extract(filename, locale){
    return new Promise((resolve, reject)=>{
        ...
        let estimatedMessages = Math.round(size/80) //around 80 bytes for the average message (including HTML), used for approximating how many messages there are       const spin = estimatedMessages > 5000
        ...
        cornet.select('html>body>.thread>.message+p', (msg)=>{
            ...
            if(spin && !hasMedia){
                if(AVERAGE_MSG == 80) AVERAGE_MSG = 0
